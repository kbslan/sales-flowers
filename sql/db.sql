...
CREATE TABLE `package_flower_record` (
	...
	`audit_id` BIGINT(19) NULL DEFAULT NULL COMMENT '审核人ID',
	`audit_time` DATETIME NULL DEFAULT NULL COMMENT '审核时间',
	`remark_id` BIGINT(19) NULL DEFAULT NULL COMMENT '评价人ID',
	`remark` VARCHAR(500) NULL DEFAULT NULL COMMENT '评价内容' COLLATE 'utf8mb4_bin',
	`remark_time` DATETIME NULL DEFAULT NULL COMMENT '评价时间',
